            ...
            <ul class="nav">
                ...
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('ticket.create')); ?>"><i class="icon-plus"></i> اشتراك جديد</a>
                        </li>
                    </ul>
                </li>
                <!--  tickets -->
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('expense.create')); ?>"><i class="icon-plus"></i>اضافة منصرف</a>
                        </li>
                    </ul>
                </li>
                <!--  expense -->
                ...
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('employee.create')); ?>"><i class="icon-plus"></i> اضافة موظفة جديد</a>
                        </li>
                    </ul>
                </li>
